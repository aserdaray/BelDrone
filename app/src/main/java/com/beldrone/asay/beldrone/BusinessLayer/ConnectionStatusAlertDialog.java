                        ...
                        class MsgUpdater implements Runnable {
                            ...
                            public void run() {
                                ...
                                if (App.getMK().version.known){
                                    ...
                                    SharedPreferences myPref = myActivity.getApplicationContext().getSharedPreferences("MyPref", 0);
                                    SharedPreferences.Editor edit = myPref.edit();

                                    edit.putBoolean("isMkSet", true);
                                    edit.putString("mkAddress", App.getMK().mk_url);
                                    edit.putString("mkName", App.getMK().name);
                                    edit.commit();
                                }
