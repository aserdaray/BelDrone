...
public class MKGPSPosition {
    ...
    public int Longitude = 288309737;
    public int Latitude = 409859805;
    ...
    public int HomeLongitude = 409859805;
    public int HomeLatitude = 288309737;
...
//#endif
    ...
    public boolean isCareFreeActive() {
        return MKHelper.isBitSet(FCFlags2, 0);
    }

    public boolean isAltitudeControlActive() {
        return MKHelper.isBitSet(FCFlags2, 1);
    }


    public boolean isRCFAilSaveActive() {
        return MKHelper.isBitSet(FCFlags2, 2);
    }

    public boolean isOutput1Active() {
        return MKHelper.isBitSet(FCFlags2, 3);
    }


    public boolean isOutput2Active() {
        return MKHelper.isBitSet(FCFlags2, 4);
    }
    ...
    public void set_by_mk_data(int[] in_arr, MKVersion version) {
        ...
        Variometer = MKHelper.parse_arr_2(off + 52, in_arr);
        ; // climb(+) and sink(-) rate
        ...
        // 69 op radius
        // 70-71 top speed
        TargetHoldTime = in_arr[off + 72];
        FCFlags2 = in_arr[off + 73];
        // 73 rc rssi
        // 74-75 set alt
        // 76 gas
        // 77/78 -current
